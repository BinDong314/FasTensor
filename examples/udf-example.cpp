...
int main(int argc, char *argv[])
{
  ...
  //Orginal data set
  Array<float> *A = new Array<float>("testf-10x10.h5p",       "/testg", "/testg/testd", chunk_size, overlap_size);

  //Results data sets
  Array<float> *B = new Array<float>("testf-10x10-func1.h5p", "/testg", "/testg/testd");
  Array<float> *C = new Array<float>("testf-10x10-func2.h5p", "/testg", "/testg/testd");
  Array<float> *D = new Array<float>("testf-10x10-func3.h5p", "/testg", "/testg/testd");

...
./au_test_data_generator -f ./test-data/testf-16x16-vds-y.h5 -g /testg -d /testg/y -n 2 -s 16,16 -t 0 -i 100
./au_test_data_generator -f ./test-data/testf-16x16-vds-z.h5 -g /testg -d /testg/z -n 2 -s 16,16 -t 0 -i 1000

...
int main(int argc, char *argv[])
{
  ...
  //mpirun -n 4x
  std::vector<int> chunk_size;    chunk_size.push_back(384);     chunk_size.push_back(576);
  ...
  if(cache_flag == 1) {
    ...
    chunk_size.resize(3); chunk_size[0]=192; chunk_size[1]=288;chunk_size[2]=8;
    overlap_size.resize(3); overlap_size[0]=0;overlap_size[1]=0; overlap_size[2]=0;
    striping_size.resize(3); striping_size[0]=2;striping_size[1]=2;striping_size[2]=2;

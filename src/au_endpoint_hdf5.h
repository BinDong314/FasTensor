...
#define H5_ENABLE_MPI_IO 0
#define H5_DISABLE_MPI_IO 1
#define H5_ENABLE_COLLECTIVE_IO 2
#define H5_DISABLE_COLLECTIVE_IO 3

//For some old code
#define OP_ENABLE_MPI_IO H5_ENABLE_MPI_IO
#define OP_DISABLE_MPI_IO H5_DISABLE_MPI_IO
#define OP_ENABLE_COLLECTIVE_IO H5_ENABLE_COLLECTIVE_IO
#define OP_DISABLE_COLLECTIVE_IO H5_DISABLE_COLLECTIVE_IO
